...
export default function MTNMoMoWidget({ bookingId, amount, onSuccess, onCancel }: MTNMoMoWidgetProps) {
  ...
  const handlePayment = async () => {
    ...
    try {
      ...
      try {
        ...
        toast({
          title: 'Error',
          description: errorData.error || 'Failed to initiate payment',
          variant: 'destructive',
        });
      } catch (e) {
        toast({
